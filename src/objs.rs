...
impl_vec_ops1! (
    ((Offset2) (Add [add +]) (Offset2) -> Offset2),
    ((Offset2) (Sub [sub -]) (Offset2) -> Offset2),
    ((Offset2) (Mul [mul *]) (Offset2) -> Offset2),
    ((Offset2) (Div [div /]) (Offset2) -> Offset2),
    ((Offset2) (Rem [rem %]) (Offset2) -> Offset2),

    ((Vec2) (Add [add +]) (Vec2) -> Vec2),
    ((Vec2) (Sub [sub -]) (Vec2) -> Vec2),
    ((Vec2) (Mul [mul *]) (Vec2) -> Vec2),
    ((Vec2) (Div [div /]) (Vec2) -> Vec2),
    ((Vec2) (Rem [rem %]) (Vec2) -> Vec2),

    ((Vec2) (Add [add +]) (Offset2) -> Vec2),
    ((Vec2) (Sub [sub -]) (Offset2) -> Vec2),
);

impl_vec_ops2! (
    ((Offset2) (Div [div /]) (f32) -> Offset2),
    ((Offset2) (Mul [mul /]) (f32) -> Offset2),

    ((Vec2) (Div [div /]) (f32) -> Vec2),
    ((Vec2) (Mul [mul /]) (f32) -> Vec2),
);
...
impl Collider {
    ...
    pub fn get_rect_bottom_right(self, self_base_pos: Vec2) -> Vec2 {
        self.get_rect_top_left(self_base_pos) + (self.get_size() / 2.0)
    }
...
event_enums!(
    ...
    /// After all data is loaded into the ObjectState, called before Load to adjust the data or do any game-specific setup needed after loading.
